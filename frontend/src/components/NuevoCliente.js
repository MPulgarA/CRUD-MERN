...
const NuevoCliente = (props) => {
    ...
    return ( 
        <>
            <h1 className="my-5">Nuevo Pedido</h1>     
            <div className="container mt-5 py-5">
                <div className="row">
                    ...
                    <div className="col-md-8 mx-auto">
                        <form onSubmit={crearNuevoCliente} className="bg-white p-5 bordered">
                            ...
                            <input type="submit" className="btn btn-success mt-3 w-100 p-3 font-weight-bold" value="Crear Pedido"/>
                        </form>
                    </div>
                </div>
            </div>
